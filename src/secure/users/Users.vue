<template>
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-botton">
        <div>
            ...
            <tr v-for="user in users" :key="user.id">
                ...
                <td>
                    <div class="btn-group mr-2">
                        <router-link :to="`/users/${user.id}/edit`" href="javascript:void(0)"
